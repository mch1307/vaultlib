...
vault write auth/approle/role/my-role policies=VaultDevAdmin secret_id_ttl=1000m token_num_uses=2 token_ttl=5s token_max_ttl=30s secret_id_num_uses=40 > /dev/null 2>&1
